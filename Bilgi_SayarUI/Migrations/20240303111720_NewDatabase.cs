        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentReleaseDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WriterNickname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WriterEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WriterBio = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Entries", x => x.ContentId);
                    table.ForeignKey(
